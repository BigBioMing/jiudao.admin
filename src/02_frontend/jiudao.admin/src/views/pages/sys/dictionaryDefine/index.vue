...
import { getPageEntitiesApi, delDictionaryDefineApi, exportApi } from '@/apis/sys/dictionaryDefine';
...
const searchForm = ref<SysDictionaryDefineGetPageEntitiesInputParams>({
  code: null,
  name: null
});
